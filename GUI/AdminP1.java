...
public class AdminP1 extends javax.swing.JPanel {
    ...
    // โหลดหนังทั้งหมดจาก AppDataManager
    List<Movie> movies = DataManager.getMovies();

    // ตัวอย่าง: สมมุติคุณมีปุ่ม jButton1 ถึง jButton8 แทนแต่ละหนัง
    // คุณสามารถตั้งค่าให้แต่ละปุ่มแสดงรูปหนังได้แบบนี้
    JButton[] buttons = { ImgMovie1, ImgMovie2, ImgMovie3, ImgMovie4, ImgMovie5, ImgMovie6, ImgMovie7, ImgMovie8, ImgMovie9, ImgMovie10 };
    ...
    private void SaveButtonActionPerformed(java.awt.event.ActionEvent evt) {                                           
        ...
        Movie edited = new Movie(name, dates, times, selectedImagePath);
